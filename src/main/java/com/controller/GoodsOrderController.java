...
//                            goodsOrderEntity.setAddressId(Integer.valueOf(data.get(0)));   //送货地址 要改的
...
//                            goodsOrderEntity.setCreateTime(date);//时间
    ...
    */
    ...
    public R add(@RequestBody GoodsOrderEntity goodsOrder, HttpServletRequest request){
        ...
        if("用户".equals(role)){
            ...
            buyJifen = new BigDecimal(goodsEntity.getGoodsPrice()).multiply(new BigDecimal(goodsOrder.getBuyNumber())).doubleValue();//所获积分
            if(balance<0)
    ...
    public R add(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        for (Map<String, Object> map : goodss) {
           //取值
            ...
            goodsOrderEntity.setAddressId(addressId);//送货地址
            ...
            if(goodsOrderPaymentTypes == 1){//余额支付
                ...
                if(yonghuEntity.getNewMoney() - money <0 ){
                    ...
                    //计算所获得积分
                    Double buyJifen =0.0;
                        buyJifen = new BigDecimal(goodsEntity.getGoodsPrice()).multiply(new BigDecimal(buyNumber)).doubleValue();
    ...
    */
    ...
    public R commentback(Integer id, String commentbackText, Integer goodsCommentbackPingfenNumber, HttpServletRequest request){
