            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='goods' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品库存" prop="goodsKucunNumber">
                        <el-input v-model="goodsForm.goodsKucunNumber"
                ...
                <el-col :span="12"  v-if="sessionTable !='goods' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品原价" prop="goodsOldMoney">
                        <el-input v-model="goodsForm.goodsOldMoney"
                ...
                <el-col :span="12"  v-if="sessionTable !='goods' ">
                    <el-form-item class="input" v-if="type!='info'"  label="点击次数" prop="goodsClicknum">
                        <el-input v-model="goodsForm.goodsClicknum"
                                  placeholder="点击次数" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="点击次数" prop="goodsClicknum">
                            <el-input v-model="ruleForm.goodsClicknum"
