    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="评价内容" prop="goodsCommentbackText">
                        <el-input type="textarea"  :readonly="ro.goodsCommentbackText" v-model="ruleForm.goodsCommentbackText" placeholder="评价内容"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.goodsCommentbackText" label="评价内容" prop="goodsCommentbackText">
                            <span v-html="ruleForm.goodsCommentbackText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            //当前text不能修改
            this.ro.goodsCommentbackText = true;
            if (this.role != "管理员"){
            }
