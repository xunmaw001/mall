        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='address'">
                    <el-form-item class="select" v-if="type!='info'"  label="送货地址" prop="addressId">
                        <el-select v-model="ruleForm.addressId" :disabled="ro.addressId" filterable placeholder="请选择送货地址" @change="addressChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='goods'">
                    <el-form-item class="select" v-if="type!='info'"  label="商品" prop="goodsId">
                        <el-select v-model="ruleForm.goodsId" :disabled="ro.goodsId" filterable placeholder="请选择商品" @change="goodsChange">
                            <el-option
                ...
                <el-col :span="24" v-if="sessionTable !='goods' ">
                ...
                <el-col :span="12"  v-if="sessionTable !='goods' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品类型" prop="goodsValue">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="订单号" prop="goodsOrderUuidNumber">
                       <el-input v-model="ruleForm.goodsOrderUuidNumber"
                                 placeholder="订单号" clearable  :readonly="ro.goodsOrderUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="订单号" prop="goodsOrderUuidNumber">
                           <el-input v-model="ruleForm.goodsOrderUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="实付价格" prop="goodsOrderTruePrice">
                       <el-input v-model="ruleForm.goodsOrderTruePrice"
                                 placeholder="实付价格" clearable  :readonly="ro.goodsOrderTruePrice"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="实付价格" prop="goodsOrderTruePrice">
                           <el-input v-model="ruleForm.goodsOrderTruePrice"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="订单类型" prop="goodsOrderTypes">
                        <el-select v-model="ruleForm.goodsOrderTypes" :disabled="ro.goodsOrderTypes" placeholder="请选择订单类型">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="订单类型" prop="goodsOrderValue">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="支付类型" prop="goodsOrderPaymentTypes">
                        <el-select v-model="ruleForm.goodsOrderPaymentTypes" :disabled="ro.goodsOrderPaymentTypes" placeholder="请选择支付类型">
                            <el-option
                                v-for="(item,index) in goodsOrderPaymentTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else>
                        <el-form-item class="input" label="支付类型" prop="goodsOrderPaymentValue">
                        <el-input v-model="ruleForm.goodsOrderPaymentValue"
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    goodsOrderUuidNumber: new Date().getTime(),
                    addressId: '',
                    goodsId: '',
                    yonghuId: '',
                    buyNumber: '',
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=goods_order_payment_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.goodsOrderPaymentTypesOptions = data.data.list;
                    }
                });
